...
export const CardBody = ({ children, className }) => {
  return (
    ...
    >
        {/* <img 
        src="https://miro.medium.com/v2/resize:fit:1400/0*u4HhPdlTiCfinMSZ" // Replace with your image URL
        alt="Description of image" // Provide an alt text for accessibility
        className="object-cover w-full h-full rounded-lg" // Tailwind classes to adjust image size
      /> */}
      {children}
    </div>
  );
